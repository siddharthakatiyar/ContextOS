    ...
    >
      ...
      <div className="flex flex-col gap-12">
          ...
          <ul className="flex flex-col gap-4 mt-2 bg-[#050505] border border-neutral-900 rounded-lg p-6">
            <li className="flex items-start gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Moved away from Redis/Qdrant to SQLite</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Background Daemon handles massive repos seamlessly</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
            ...
            <li className="flex items-start gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Automated linting, formatting, tests, and CLI tracing</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
        ...
        <div className="flex flex-col gap-6 relative">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight m-0 text-neutral-300">v1.x (Post-Launch Hardening)</h2>
          </div>
          ...
          <ul className="flex flex-col gap-4 bg-black border border-neutral-900 rounded-lg p-6">
            <li className="flex items-start gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Refining our local embeddings fallback and evaluating alternative, faster on-device models.</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-neutral-700 shrink-0 mt-2" />
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Exposing more granular graph-traversal capabilities to connected LLMs via the Model Context Protocol.</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-neutral-700 shrink-0 mt-2" />
              <div className="flex flex-col">
                ...
                <span className="text-neutral-500 text-sm">Ensuring native Windows path handling and daemon stability.</span>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-6 relative">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight m-0 text-neutral-400">Long-term Vision (v2.0+)</h2>
          </div>
          ...
          <ul className="flex flex-col gap-4 bg-black border border-neutral-900 rounded-lg p-6">
            <li className="flex items-start gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-neutral-600 text-sm">Securely sharing project metadata across developer teams.</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-neutral-700 shrink-0 mt-2" />
              <div className="flex flex-col">
                ...
                <span className="text-neutral-600 text-sm">Watching developer cursor movements to preemptively assemble context before an LLM query is even fired.</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-neutral-700 shrink-0 mt-2" />
              <div className="flex flex-col">
                ...
                <span className="text-neutral-600 text-sm">Bringing ContextOS directly into IDE hover states.</span>
              </div>
            </li>
          </ul>
        </div>
