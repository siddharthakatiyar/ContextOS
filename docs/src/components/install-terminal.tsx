...
export function InstallTerminal() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-2xl mx-auto rounded-xl border border-neutral-800 bg-[#0a0a0a] font-mono text-sm shadow-2xl overflow-hidden text-neutral-400"
    >
      {/* Terminal Header */}
      ...
      <div className="p-6 h-[240px] flex flex-col gap-3 text-left items-start">
        ...
        {step >= 4 && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mt-2 text-[#27c93f] font-medium flex gap-2"
          >
            <span>✓</span>
